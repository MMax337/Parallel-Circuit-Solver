...
import tests.TestUtils.LeafNodeInterruptsCount;
...
public class StopTests {
  ...
  @BeforeEach
  void initialize() {
    pSolver = new ParallelCircuitSolver(1000);
  }
  ...
  @Test
  void test3() {
    Circuit[] circuits = new Circuit[80];
    int start = 2;
  ...
  void test4() {
    ...
    assertTrue(elapsed < 20, "Elapsed " + elapsed);
  }
}
